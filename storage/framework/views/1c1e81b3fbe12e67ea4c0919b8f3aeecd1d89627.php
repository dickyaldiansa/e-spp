       ...
       <div class="row align-items-center">
         <div class="col-lg-6">
           <div class="pr-5">
             ...
             <h2 class="display-4 text-white font-weight-light">SMK Wikrama 1 CIKUYA</h2>
             <p class="text-white mt-4">Pembayaran SPP Online Berbasis Web</p>
             <div class="mt-5">
               <a href="<?php echo e(url('contact')); ?>" class="btn btn-neutral my-2">E - mail</a>
               <a href="https://wa.me/6283815432987" class="btn btn-success my-2">Whatsapp</a>
             </div>
           </div>
         </div>
         <div class="col-lg-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MY BLOG LARA\PREMIUM\e-spp\resources\views/welcome.blade.php ENDPATH**/ ?>