    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          <a href="<?php echo e(url('admin/spp/add')); ?>" class="btn btn-sm btn-neutral">Add</a>
        </div>
      </div>
    </div>
  </div>
        ...
        <table class="table table-flush" id="datatable-basic">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo e($d->period); ?></td>
              <td><?php echo e($d->amount); ?></td>
              <td><?php echo e($d->info); ?></td>
              <td><?php echo e($d->total); ?></td>
              <td>
                <a href="<?php echo e(url('admin/spp/edit').'/'.$d->id); ?>" class="btn btn-sm btn-warning text-white" title="Edit Data"><i class="ni ni-ruler-pencil"></i></a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MY BLOG LARA\PREMIUM\e-spp\resources\views/spp/index.blade.php ENDPATH**/ ?>