    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          <a href="<?php echo e(url('admin/students/add')); ?>" class="btn btn-sm btn-neutral">Add</a>
          <a href="<?php echo e(url('admin/students/import')); ?>" class="btn btn-sm btn-neutral">Import</a>
        </div>
      </div>
    </div>
  </div>
        ...
        <table class="table table-flush" id="datatable-basic">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo e($d->rombel->name); ?></td>
              <td><?php echo e($d->gender); ?></td>
              <td><?php echo e($d->spp->info); ?> ~ Rp<?php echo e(number_format($d->spp->amount, 2)); ?></td>
              <td>
                <a href="<?php echo e(url('admin/students/edit',$d->id)); ?>" class="btn btn-sm btn-warning text-white" title="Edit Data"><i class="ni ni-ruler-pencil"></i></a>
                ...
                <a href="<?php echo e(url('admin/students/detail', $d->id)); ?>" class="btn btn-sm btn-info text-white" title="Detail Data"><i class="ni ni-zoom-split-in"></i></a>
              </td>
            </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MY BLOG LARA\PREMIUM\e-spp\resources\views/students/index.blade.php ENDPATH**/ ?>