			...
			<div class="col-lg-6">
				<div class="card bg-gradient-danger border-0">
					...
					<div class="card-body">
						<div class="row">
							<div class="col">
								<h5 class="card-title text-uppercase text-muted mb-0 text-white">Bulan Pembayaran Terakhir</h5>
			...
			<div class="card-header">
				<div class="row align-items-center">
					...
					<div class="col-4 text-right">
						<a href="{{ url('admin/edit', $data->id) }}" class="btn btn-sm btn-primary">Edit Data</a>
					</div>
				</div>
			</div>
			<div class="card-body">
