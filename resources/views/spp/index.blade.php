    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          <a href="{{ url('admin/spp/add') }}" class="btn btn-sm btn-neutral">Add</a>
        </div>
      </div>
    </div>
  </div>
        ...
        <table class="table table-flush" id="datatable-basic">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $d->total }}</td>
              <td>
                <a href="{{ url('admin/spp/edit').'/'.$d->id }}" class="btn btn-sm btn-warning text-white" title="Edit Data"><i class="ni ni-ruler-pencil"></i></a>
