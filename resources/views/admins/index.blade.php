    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <a href="{{ url('admin/data/import') }}" class="btn btn-sm btn-neutral">Import</a>
        </div>
      </div>
    </div>
  </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="{{ url('admin/data/detail').'/'.$d->id }}" class="btn btn-sm btn-info text-white" title="Detail Data"><i class="ni ni-zoom-split-in"></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
